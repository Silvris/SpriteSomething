...
class Game(GameParent):
    def __init__(self, my_subpath=""):
        ...
        self.name = "Mega Man 2"  #to be replaced by a name like "Super Metroid"
        self.console_name = "nes"			#to be replaced by the console name, e.g. "snes"
        self.internal_name = "megaman2"	#to be replaced by the specific folder name that this app uses, e.g. "metroid3"
